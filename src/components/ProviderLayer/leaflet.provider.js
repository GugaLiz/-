    ...
    L.TileLayer.Provider.providers = {
        ...
        QQMap: {
            ...
            variants: {
                ...
                Label: {
                    url: 'http://rt{s}.map.gtimg.com/tile?z={z}&x={x}&y={y}&styleid=2&version=259'
                },
                Label2: {
                    url: 'http://rt{s}.map.gtimg.com/tile?z={z}&x={x}&y={y}&type=vector&styleid=3&version=259'
                    //url: 'http://rtt2.map.qq.com/rtt/?z={z}&x={x}&y={y}&times=1&time={time}' //实时路况
                },

                Satellite: {
                    url: 'http://p{s}.map.gtimg.com/sateTiles/{z}/{x16}/{y16}/{x}_{y}.jpg?version=229'
                }
            }
        },
        OpenStreetMap: {
        ...
        StaticMap: {
            //url: Fleet.Url('/Airfleet/MapStatic?maptype=Road&img={z}_{x}_{y}&img2=z{z}_{y}_{x}.png'),
            url:'http://172.16.0.80:8084/Default.aspx?maptype=map&img={z}_{x}_{y}',
            options: {
                minZoom: 4,
                maxZoom: 16,
                subdomains: ['t1', 't2', 't3', 't4'],
