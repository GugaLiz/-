...
(function(factory, window) {
  ...
  L.Editable.VertexMarker = L.Marker.extend({
    ...
    onAdd: function(map) {
      ...
      var e = { vertex: this };
      this.editor.fireAndForward('editable:vertex:add', e);
    },
  ...
  L.Editable.MiddleMarker = L.Marker.extend({
    ...
    onMouseDown: function(e) {
      ...
      e.vertex = marker;
      this.editor.onMiddleMarkerMouseAdd(e);
      this.delete();
    },
  ...
  L.Editable.PathEditor = L.Editable.BaseEditor.extend({
    ...
    addVertexMarker: function(latlng, latlngs, opt) {
      return new this.tools.options.vertexMarkerClass(latlng, latlngs, this, opt);
    },
    ...
    onMiddleMarkerMouseAdd: function(e) {
      this.fireAndForward('editable:middlemarker:add', e);
    },
